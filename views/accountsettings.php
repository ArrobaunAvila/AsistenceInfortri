        ...
        <div class="col-md-6">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
               <h3 class="box-title">Configuracion de Contraseña</h3>
            </div>
            <!-- /.box-header -->
              ...
              <div class="box-body">
                <div class="form-group">
                  <div class="box-header">
                    <p>Si cambias la contraseña ,<b> se cerrará la sesión</b> e ingresaras Nuevamente
                     con al sistema.</p>
                  </div>

                  <div class="col-md-7" style="margin-top: 3px">
                     <div class="input-group">
                    <input id="password" type="password" class="form-control" placeholder="Actual Contraseña" required>
                    <span style="cursor: pointer;" class="input-group-addon" id="view_password"><icon class="fa fa-eye-slash"></span>
                   </div>
                  </div>
                </div>
                ...
                <div class="col-md-7" style="margin-top: 35px">
                   <div class="form-group">
                     <div class="input-group">
                    <input id="nueva_password" type="password" class="form-control input_validar" placeholder="Nueva Contraseña" required>
                    <span style="cursor: pointer;" class="input-group-addon" id="view_password"><icon class="fa fa-eye-slash"></span>
                   </div>
                   </div>
                </div>
                ...
                <div class="col-md-7">
                   <div class="form-group">
                     <div class="input-group">
                    <input id="repetir_password" type="password" class="form-control input_validar" placeholder="Repetir Contraseña" required>
                    <span style="cursor: pointer;" class="input-group-addon" id="view_password"><icon class="fa fa-eye-slash"></span>
                   </div>
         ...
         <div class="alert alert-info alert-dismissible" id="alert-info-error" style="display: none; width: 30rem">
                ...
                <p id="info_alert">Verifique su contraseña actual</p>
              </div>
             ...
             <div class="box-footer">
                <button type="submit" class="btn btn-primary" id="change-button">CAMBIAR CONTRASEÑA</button>
              </div>
          </div>
          <!-- /.box -->
